...
- Chaque binaire est signé avec la clé Ed25519 du projet (vérifiée par l'auto-updater).
- Le SHA256 de chaque asset est publié dans `SHA256SUMS.txt` à chaque release.
- Chaque binaire est soumis à VirusTotal avant publication.

## Retours

Bug, suggestion, erreur de stratégie : page [Retours](https://dofuscompanion.com/retours) du site officiel.
